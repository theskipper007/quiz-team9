...
function myFunction() {
    ...
    //Assign correct answers to field inputs
      if (q1.toUpperCase() === "CHINA") {
        ...
        document.getElementById("answers").innerHTML = "Correct answers: (1)a (2)b (3)c(4)d (5)True (6)DOM (7)a (8)5 (9)b (10)d(11)c (12)c (13)c (14)true (15)a (16)1914 (17)Austria (18)Dallas (19)France (20)10";
